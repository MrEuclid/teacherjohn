...
<a href = "indexCertificates.php"><button>
            ...
            <table id="dataTable" class="min-w-full divide-y divide-gray-200">
                <thead class="bg-blue-50">
                    <tr>
                       ...
                       <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider rounded-tr-lg">Objectives</th>   
                        <th class="px-6 py-2 text-left text-xs font-medium text-gray-500 uppercase tracking-wider rounded-tr-lg">Photo</th>
 ...
 $.ajax({
            ...
            url:"ajax/getCertificate.php",
                ...
                //    console.log(res);
                  ...
                  //  alert(data.length);
                    for (let i =0 ; i < data.length; i++)
                      options += '<option value="' + data[i].title + '-' + data[i].objectives + '" />';
...
if (l > 0)
{
            ...
            $.each(data, (index, student) => {
                const row = `
                    <tr class="hover:bg-blue-50">
                        ...
                        <td class="px-6 py-2 whitespace-nowrap text-sm text-gray-900">${student.Name}</td>
                        <td class="px-6 py-2 whitespace-nowrap text-sm font-semibold text-blue-600">${student.Grade}</td>   
                        <td class="px-6 py-2 whitespace-nowrap text-sm font-semibold text-blue-600">${student.Certificate}</td>  
                        <td class="px-6 py-2 whitespace-nowrap text-sm font-semibold text-blue-600">${student.Objectives}</td>  
        ...
        function downloadDataAsCsv(rawArray, filename) {
            ...
            const headers = ['ID', 'Name','Grade','Certificate','Objectives' , 'Photo']; 
