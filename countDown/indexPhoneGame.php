...
<link rel="stylesheet" href="../css/templeStyles.css">
    ...
    <title>Phone game - Alien phone sales</title>
<style type="text/css">
...
#personalDataTable {background-color: yellow ;} 

#error {color:red ; text-align:center; font-weight:bold ; font-size:12pt ;}  
#registerTeam, 
#cancelRegistration, 
#clearRegistration, #acceptTeam, 
#cancelTeam , 
#cancelPrice,
#submitPrice ,
#submitBuy, 
...
input {
  ...
  #currentRound , #rooms, #stock, #ourTeamID , #aliensArriving , #stock{
      width:40px ;
...
#numberPhones {text-align:center ; color:black; background-color:lightblue ; font-size:12pt ; font-weight:bolder ; width:120px ; }
...
{font-size:16pt ; color:black ; text-align:center ; margin-top:50px ;}
...
<h1>The Phone Game</h1>


<a href = "indexPhoneGame.php"><button  class="btn btn-primary btn-lg">New</button></a>
