...
<html lang="en">
  ...
  <title>greenLight game a times b</title>
  <meta charset="utf-8">
...
<div class = "row align-items-center h-100 c">
 ...
 <div  id = "message" >
  <ul>
 <li>Put numbers in each row so that the numbers multiply to make the number at the end of the row.</li>
 <li>Put numbers in each column so that the numbers multiply to make the number at the top of the column.</li>
...
$('#listCalculations').append(a + '&times;' + c  + ' = ' + answerC1);
// check if correct 
