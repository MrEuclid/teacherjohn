...
<div class="container-fluid">
    <div class="row">
        <div class="col-md-12 c">
            ...
            <a href="/monopoly/mBooks/mBookv2.php" target="_blank"><button class="btn btn-warning">mBooks login</button></a>
 ...
 <a href = "http://pio-students.net/monopoly/mBooksAdmin.php"
target = "_blank"><button class = "btn btn-info" >mBooks Admin</button></a>
