...
<body>
  ...
  <div class = "col- ">
   <h1> MBooks Report </h1><p id = "who"></p>
  </div></div>
...
console.log(" accounting",number,money);
...
$('#assetNames').empty();
$('#assetValues').empty();
$('#liabilityNames').empty();
$('#liabilityValues').empty();
...
while (category == "1")
{
     ...
     console.log(amt,formatAccounting(amtformatted));
     acc =formatAccounting(json[i].linkedAccount) ;
...
while (category == "4")
{
  console.log("Category ",category);
     ...
     if (category == 4)
  {
    $('#incomeNames').append(name + formatAccounting(acc)  + "<br>");
...
{
     console.log("Category ",category);
     amt = formatAccounting(json[i].linkedAmount) ;
     amtformatted = formatAccounting(amt);
