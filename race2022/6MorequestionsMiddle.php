...
<title>6 Questions More question middle</title>
...
<script type="text/javascript">
...

    {
        ...
        var expr = '$' + 'y =  ' + a + ', x = ' + '\\frac{y^3 - 1}{y-1}' +  ' , x = $';
...
<script type="text/javascript">
...

    {
           ...
           var a = randomInteger(7,20) ;
       
        console.log("a",a) ;
        var term = 'y = ' + a  + ' , x = ';
         term = term + '$' + ' \\frac{y^4 -1}{y^2 + 1}'  + ' , x = $' ;
...

    {
        ...
        if (guess == answer[qNumber])
        {
...

            {
                ...
                alert("You have solved " + points/2 + " equations!");
