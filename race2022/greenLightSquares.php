...
#squareNumbers {background-color: white; color: blue; font-size: 1.2em; font-weight: bold;font-family: monospace;}
...
// var levelID = this.id ;
var level = 1
// levelID.substring(5, 6);  // parse to get last digit = the playing level
...
{ 
    ...
    alert("You have made the lights green!");
...
processWin(questionID);
    console.log("processing ",questionID);
     ...
     $('#play').empty().show();
     $('#q16').prop('disabled',true).css({"background-color":"blue","color":"yellow"});
