...
<title>2024 Maths Practice</title>
...
Welcome to the Maths Practice 2024
...
<h1 id = "instructions">Choose your game</h1>
  ...
  <div class = "col- text-center">
    ...
    <button class = "easy" id = 'q1'>Find the number-2</button>
    <button class = "easy" id = 'q17'>Make a Colour-4</button> 
    <button class = "easy" id = 'q4'>Only 4 colours-2</button> 
    <button class = "easy" id = 'q5'>Sort the Fractions-4</button>
    <button class = "easy" id = 'q9'>Mastermind easy-3</button> 
    <button class = "easy" id = 'q13'>Fractions easy-4</button> 
    <button class = "easy" id = 'q14'>Three Equations-6</button> 


    <button class = "medium" id = 'q16'>Add two Squares-5</button> 
    <button class = "medium" id = 'q12'>Use Four 4s-6</button> 
     <button class = "medium" id = 'q19'>Juniors Find x - 12</button> 
