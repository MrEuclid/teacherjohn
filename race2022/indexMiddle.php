...
<link rel="stylesheet" href="../race2024/css/race2024.css">

    <meta charset="utf-8">
    
    <meta name="description" content="">
    <meta name="keywords" content="">
<title>2024 Maths Competition G8 G9</title>
...
.g8 {background-color: lightblue ; color:black;}
.g9 {background-color: lightgreen; color:black;}
.g10 {background-color: pink;color:black;}
  </style>
...
Welcome to the Maths Competition 2024 - G8 & G9
...
<h1 id = "instructions">Choose your game</h1>
  ...
  <div class = "col- text-center">
    ...
    <button class = "g8" id = 'q1'>Find the number-2</button>

    <button  class = "g8" id = 'q17'>Make a Colour-4</button> 
 <!--
    <button class = "easy" id = 'q4'>Only 4 colours-2</button> 
-->
    <button  class = "g9" id = 'q5'>Sort the Fractions-4</button>
    <!--
    <button class = "easy" id = 'q9'>Mastermind easy-3</button> 
    -->
    <!--
    <button  id = 'q13'>Fractions easy-4</button> 
     -->
    <button class = "g9" id = 'q28'>Lines - 6</button> 
</div></div>
 <div class = "row">
  <div class = "col- text-center">

    <button  class = "g9" id = 'q14'>Three Equations - 6</button> 
<button  class = "g9" id = 'q29'>Parabolas - 6</button> 
   <button class = "g9" id = 'q30'>New Equations - 6</button> 
    <button class = "g9" id = 'q16'>Add two Squares - 5</button> 

</div></div>

  <div class = "row">
  <div class = "col- text-center">
    <button class= "g8" id = 'q18'>Tigers game - 8</button> 
    <button class = "g9" id = "q27">Quadratics - 12</button>
   <button class = "g9" id = 'q2'>Egyption Fractions - 7</button>
    <button  class = "g9"  id = 'q11'>Solve the equations - 7</button>
</div></div>

  <div class = "row">
  <div class = "col- text-center">
           <button class = "g9"  id = 'q15'>Factors - 7</button> 
           <!--
            <button class = "g10" id = 'q8'>Add the fractions - 7</button>
            
         <button class = "g10" id = 'q6'>Sort the surds - 8</button>
    <button class = "g10" id = 'q3'>Green light - 9</button>
-->
</div></div>
  <div class = "row">
  <div class = "col- text-center">
...
points = parseInt(value.substr(-1));
alert("v" + value + " " + points)
...
<script type="text/javascript">
...

  {
    ...
    var value = "Fractions - 4";
   $('#play').load("sortFractionsMiddle.php",{question: value});
...
<script type="text/javascript">
...

  {
    ...
    var value = $('#q7').text();
   $('#play').load("countDownNumberMiddle.php",{question: value});
...
<script type="text/javascript">
...

  {
    ...
    var value = $('#q8').text();
   $('#play').load("make1Middle.php",{question: value});
...
var value = $('#q19').text();
   $('#play').load("6questionsMiddle.php",{question: value});
...
var value = $('#q21').text();
   $('#play').load("6MorequestionsMiddle.php",{question: value});
...
var value = $('#q30').text();
   $('#play').load("linearEquations.php",{question: value});
...
var value = $('#q27').text();
   $('#play').load("quadraticEquations.php",{question: value});
...
var value = $('#q28').text();
   $('#play').load("lines.php",{question: value});
...
var value = $('#q29').text();
   $('#play').load("parabolas.php",{question: value});
...
team = remove_linebreaks(response) ;
