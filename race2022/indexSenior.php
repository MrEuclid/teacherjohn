...
<title>2024 Maths Competition</title>
...
Welcome to the Maths Competition 2024 - G10
...
-->
  ...
  <div class = "col-12 text-center">
       ...
       <button  id = 'q5'>Sort the Fractions - 8</button>
         <button  id = 'q17'>Make a Colour - 4</button> 
       <button  id = 'q16'>Add two Squares - 5</button> 
      <button id = 'q8'>Add the fractions - 9</button>
    <!--
...
-->
  ...
  <button  id = 'q3'>Green light  - 6</button>
</div></div>
  ...
  <div class = "col-12 text-center">
       ...
       <button  id = 'q19'>Find x Easy - 12</button> 
         <button  id = 'q27'>Find x Medium- 12</button> 
