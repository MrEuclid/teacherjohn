...
<title>2023 Race Wat Phnom</title>
...
#login {margin:10px; color:yellow; background-color: green;}
...
<h1>Welcome to the Race to Wat Phnom 2023</h1>
...
<a href = "../index.php"><button id = "home">Home</button></a>
 ...
 <div class = "row">
    ...
    <br>
    <p id = "words2" class = "c"> After you have solved 10 puzzles have won the game.</p>  
     <h3> Good luck!</h3> 
  </div>
</div>
  </div></div>
...
<h2 id = "instructions">Click start</h2>
</div></div>
  ...
  <div class = "col-12 text-center">
    ...
    <button  id = 'q6'>Sort the surds - 6</button>
    <button  id = 'q7'>Make the Number - 6</button> 
    <!--
...
-->
  ...
  <div class = "row">
  <div class = "col-12 text-center">
    <button  id = 'q2'>Egyptiona Fractions - 7</button>
    <button  id = 'q3'>Green light  axb + a + b- 6</button>
       <button  id = 'q19'>Find x Easy - 9</button> 
         <button  id = 'q20'>Find x Medium- 9</button> 
          <button  id = 'q21'>Find x Hard- 9</button> 
  ...
  <div class = "col- text-center">
    ...
    <button  id = 'q16'>Add two Squares-5</button> 
    <button  id = 'q12'>Use Four 4s-6</button> 
     <button id = 'q19'>Juniors Find x - 9</button> 
 </div></div>  
 <!--
...
// grade = "junior";
 ...
 <script type="text/javascript">
    ...
    $(document).ready(function(){
      ...
      data = [] ; 
        $('#q0').css({"background-image":"url('images/templeLearning.png')"});
/*
      $('#q').css({"background-image":"url('images/sisowathQuay.jpg')"});
      $('#q2').css({"background-image":"url('images/russianMarket.jpg')"});
      $('#q3').css({"background-image":"url('images/royalPalace.jpg')"});

      $('#q4').css({"background-image":"url('images/aeonMall.jpg')"});
      $('#q5').css({"background-image":"url('images/nationalMuseum.jpg')"});
      $('#q6').css({"background-image":"url('images/independenceMonument.jpg')"}); 

      $('#q7').css({"background-image":"url('images/silverPagoda.jpg')"});
      $('#q8').css({"background-image":"url('images/phsarThmei.jpg')"});

      $('#q9').css({"background-image":"url('images/watPhnom.jpg')"});

      $('[id^=q]').attr("disabled",false);
...
<script type="text/javascript">
    ...
    $('#q0').on('click', function()
  {
    ...
    var value = $('#q0').text();
    var value = "Add primes 4"; 
   $('#play').load("addPrimes.php",{question: value}) ;
