...
<head>
  ...
  <script 
  src="../javaScript/bootStrap/bootstrap-3.3.7-dist/js/bootstrap.min.j">
  </script>
...
<div id = "puzzle-5">
  ...
  <div class = "row">
    <div class = "col-sm-12">
    <h2 class = "c" 
style="background: yellow ; color: green ; font-family: monospace;"> 
    I love PIO - I love Maths</h2>
...
if (x == solution & isPrime(answerA) & isPrime(answerB) )
{
$('#comment-1').text(solution) ;
 solved[1] = 1 ;
 $('#escapeKey').text('2') ;
...
if (answerA > 0 & answerB > 0)  {alert('Keep trying!') ;}
  };
...
solved[3] = 1 ;
 displayUnsolved() ;
 $('#visited').append('<img class = "thumb c" src = "images/aeonMall.jpg">')} else {alert('Keep trying'); }
});
...
if (z == solution)
{
 ...
 $('#visited').append('<img class = "thumb c" src = "images/sisowatQuay.jpg">')
  ...
  { 
    if (answerX > 0 & answerY > 0) {alert('Not solved yet ');}
  }
});
...
if (myUpperWord.toUpperCase() == solution.toUpperCase())
{
...
if (answerA == solutionX & answerB == solutionY  )
{$('#comment-8').text('Solved') ;
 ...
 displayUnsolved() ;
 $('#visited').append('<img class = "thumb c" src = "images/royalPalace.jpg">')} else {alert('Not solved yet ')}
});
...
if (answerA == solutionA & answerB == solutionB  & answerC == solutionC)
...
$('#input-9a','#input-9b','label-9a', "#input-9c").css({"background-color":"green","color":"white"}) ;
 ...
 displayUnsolved() ;
 $('#visited').append('<img class = "thumb c" src = "images/nationalMuseum.jpg">')} else {alert('Not solved yet ')}
});
