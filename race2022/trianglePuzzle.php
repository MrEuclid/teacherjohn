...
<body>
    ...
    <h3>First you need to to find A , B and C and then use those numbed to find D.</h3>
...
Find A,B and C first and then calculate D.
 ...
 <div class = "row">
      <div class = "col- ">
        ...
        <label>D = </label><input id = "answer"><button id = "check" >Check</button>
...
/*
     ...
     var pts = parseInt($('#total').text());
  */   
    alert("You have solved the three equations!");
