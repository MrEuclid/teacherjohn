...
// z1/z3  + z2/z4

    {
      a = 1;
    // (z1*z4 + z2*z3 / (z3*z4)
console.log("fractions ",z1,z2,z3,z4) ;   
...
console.log("denominator",denominator);
 a = math.divide(numerator,denominator);
console.log("num den a",numerator. denominator,a);
...
<script>
      ...
      function makeQuestion4(z1,z2,z3,z4)
// z1 / z2 

    {
        let p = math.divide(z1,z3);
        let q = math.divide(z2,z4);
         let a = math.divide(p,q);
...
<script type="text/javascript">
  ...
  while (gcd(c,d) != 1)
    ...
    z1 = math.complex(a,b);
    z2 = math.complex(c,d);
    z3 = math.complex(a,-1);  // makes adding easier 
    z4 = math.complex(a,1); // makes adding easier
   ...
   var expr = '$  z_1 = \\frac{' + num1 + '}{' + denom1 + '} $';
        expr +=  " and " ;
        expr += '$ z_2 = \\frac{' + num2 + '}{' + denom2 + '} $';
...
ans = makeQuestion1(z1,z2,z3,z4) ;
answer[1] = ans;

ans = makeQuestion2(z1,z2,z3,z4) ;
answer[2] = ans;
