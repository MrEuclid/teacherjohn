...
<script type="text/javascript">
 ...
 //   y = (x+a)(x-b)(x-c) = (x+a)(x^2 -x(b+c) +bc)
// y = x^3  +  ax^2 + x(bc -ab -ac) -abc ;
// a < b < c

    {
let a = randomInteger(2,5);  // x^2 - a^2
...
<script>
   ...
   //      alert("Checking " + answer[qNumber]+ " " + guess + " " + (guess - answer[qNumber]));
         let error = Math.abs(guess-answer[qNumber]);
        if (error < 0.005)
        {
            alert("Correct");
