...
// 2. EXTRACT GRADE: Turns '10A' into '10' so we know which questions to show
$grade = substr($classCode, 0, 2); 
...
<nav class="navbar navbar-dark bg-dark mb-4">
    <div class="container-fluid">
        <span class="navbar-brand mb-0 h1">Senior Maths Comp - Class <?php echo $classCode; ?></span>
